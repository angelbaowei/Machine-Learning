...
def Newton(theta, epoch):
    ...
    for count in range(epoch + 1):
        ...
        if count % 1 == 0:
            ...
            plt.plot(count_list, loss_list, color='r')
            plt.subplot(224)
            plt.xlim(0, epoch)
            plt.ylim(-1, 2)
            plt.xlabel('step')
            ...
            plt.plot(count_list, theta0_list, color='r')
            plt.plot(count_list, theta1_list, color='b')
            plt.plot(count_list, theta2_list, color='g')
