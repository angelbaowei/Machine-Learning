...
def SGD(theta, lr, epoch):
    ...
    for count in range(epoch + 1):
        ...
        if count % 10 == 0:
            ...
            plt.xlabel('step')
            plt.ylabel('lr')
            plt.scatter(count, lr, color='r', label='lr')
            ...
            plt.scatter(count, theta[0][0], color='r', label='theta0', s=10)
            plt.scatter(count, theta[1][0], color='b', label='theta1', s=10)
            plt.scatter(count, theta[2][0], color='g', label='theta2', s=10)
